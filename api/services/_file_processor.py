...
import shutil
import zipfile
from helpers.browse import recreate_folders_and_files
...
def process_file(file_path: str, artifact_name: str, gen_path: str):
    ...
    base_path=GENERATED_APP_DIR + "src\main\java\com\example\\" + artifact_name

    # puis generer les domaines, infrastructures, presentation
    # output_folder = os.path.join(artifact_name, "java_files")
    # os.makedirs(output_folder, exist_ok=True)

    recreate_folders_and_files(TEMPLATES_DIR,base_path,interpreted_data)
